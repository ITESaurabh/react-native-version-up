...
describe('Colorize module', () => {
  ...
  test('Multiple options', () => {
    expect(colorize('Test message', null, [OPTIONS.bold, OPTIONS.underline])).toBe(
      '\u001B[4m\u001B[1mTest message\u001B[0m'
    );
  });

  test('Color with option', () => {
    expect(colorize('Test message', COLORS.red, [OPTIONS.bold])).toBe(
      '\u001B[1m\u001B[31mTest message\u001B[39m\u001B[0m'
    );
  });
});
